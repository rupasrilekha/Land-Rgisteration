...
var Loader = /*#__PURE__*/React.memo(CircularProgressSpinner);
...
const DecryptButton = ({
  ...
  return jsx(ActionButton, Object.assign({
    ...
    children: isLoading ? jsx(Loader, {}) : btnText
  }));
};
  ...
  return jsxs(Container$6, Object.assign({
    ...
    children: [jsxs(MobileHeader, Object.assign({
      ...
      children: [jsxs(HeaderButton, Object.assign({
        ...
        children: [jsx(ImageContainer, Object.assign({
          theme: theme
        }, {
      ...
      })), chainName && chainDetails[chainName] ? jsxs(BlockchainContainer, {
        children: [jsxs(NetworkDetails, Object.assign({
          theme: theme
        }, {
          children: [jsx(DelieveredViaText, {
      ...
      jsx(MobileImage, Object.assign({
        ...
        children: [jsx(ChannelTitle, {
          children: jsx(ChannelTitleLink, Object.assign({
            theme: theme
          }, {
            children: notifTitle
          }))
        ...
        children: jsxs(ButtonGroup, {
          children: [isSpam && jsx(ActionButton, Object.assign({
            ...
            children: subscribeLoading ? jsx(Loader, {}) : "opt-in"
...
const NetworkDetails = /*#__PURE__*/styled.div.withConfig({
...
const DelieveredViaText = /*#__PURE__*/styled.div.withConfig({
...
const NetworkName = /*#__PURE__*/styled.div.withConfig({
...
const ChainIconSVG = /*#__PURE__*/styled.div.withConfig({
...
const ImageContainer = /*#__PURE__*/styled.span.withConfig({
...
const ChannelTitleLink = /*#__PURE__*/styled.a.withConfig({
...
const SubscribedModal = ({
  ...
  return jsx(Overlay, Object.assign({
    ...
    children: jsxs(Modal$1, Object.assign({
      className: "modal",
      ref: modalRef
    }, {
...
const CloseButton = /*#__PURE__*/styled.a.withConfig({
...
const Modal$1 = /*#__PURE__*/styled.div.withConfig({
...
const ChatPropsContext = /*#__PURE__*/createContext({});
...
const ChatInput = () => {
  ...
  const handleSubmit = e => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (message.trim() !== '' && connectedUser) {
      const sendResponse = yield PushAPI.chat.send({
  ...
  return jsx(Container$5, {
    children: messageBeingSent ? jsx(ItemHV2, {
      ...
      children: [jsx(TextInput, {
        ...
        children: [jsx("label", {}), filesUploading ? jsx("div", Object.assign({
          className: "imageloader"
        }, {
          children: "Loading..."
        })) : jsx(Fragment, {
          children: jsx(Image$4, {
            src: img$2,
            alt: "Send Message",
            height: "27px",
            width: "27px",
...
const Container$5 = /*#__PURE__*/styled.div.withConfig({
...
const TextInput = /*#__PURE__*/styled.textarea.withConfig({
...
const createUserIfNecessary = options => __awaiter(void 0, void 0, void 0, function* () {
  ...
  let connectedUser = yield PushAPI.user.get({
    account: account,
    env
  });

  if (!(connectedUser === null || connectedUser === void 0 ? void 0 : connectedUser.encryptedPrivateKey)) {
    connectedUser = yield PushAPI.user.create({
      account: account,
      env
    });
  }

  const decryptedPrivateKey = yield PushAPI.chat.decryptWithWalletRPCMethod(connectedUser.encryptedPrivateKey, account);
...
const getChats = options => __awaiter(void 0, void 0, void 0, function* () {
  ...
  const threadhash = yield PushAPI.chat.conversationHash({
    account: account,
  ...
  if (threadhash.threadHash) {
    const chats = yield PushAPI.chat.history({
      account: account,
...
const Container$4 = /*#__PURE__*/styled.div.withConfig({
...
const AddressInfo = () => {
  ...
  useEffect(() => {
    const getUser = () => __awaiter(void 0, void 0, void 0, function* () {
      const user = yield PushAPI.user.get({
...
const Chats = ({
  ...
  return jsx(Container$2, {
    children: jsx(Fragment, {
      children: msg.messageType === 'Text' ? jsx(Fragment, {
        children: msg.fromCAIP10 === caip10 ? jsx(MessageWrapper, Object.assign({
          align: "row-reverse"
        }, {
          children: jsxs(SenderMessage, {
        ...
        })) : jsx(MessageWrapper, Object.assign({
          align: "row"
        }, {
          children: jsxs(ReceivedMessage, {
            children: [jsx(TextMessage, {
              children: msg.messageContent
            }), jsx(TimeStamp, {
              children: date
...
const Modal = () => {
  ...
  return jsxs(Container$1, {
    children: [jsxs(HeaderSection, {
      children: [jsx(ModalHeader, {}), jsx(AddressInfo, {})]
    }), jsx(ChatSection, {
      children: connectedUser && chats.length ? chats.map(chat => jsx(Chats, {
        msg: chat,
        caip10: walletToPCAIP10(account),
        messageBeingSent: true
      })) : jsx(Fragment, {})
    }), !connectedUser && jsxs(ConnectSection, {
      children: [jsx(Button$1, Object.assign({
        onClick: () => connectUser()
      }, {
        children: "Connect"
      })), jsx(Span, {
      ...
      children: [connectedUser && jsx(ChatInput, {}), jsx(Image$1, {
        src: img,
...
const InputSection = /*#__PURE__*/styled.div.withConfig({
...
const Chat = ({
  ...
  return jsx(Container, {
    children: jsx(ChatPropsContext.Provider, Object.assign({
      value: chatPropsData
    }, {
      children: jsxs(ChatMainStateContext.Provider, Object.assign({
        value: chatMainStateData
      }, {
        children: [!isModalOpen && jsx(Button, Object.assign({
...
export { Chat, NotificationItem, ParseMarkdownText, SubscribedModal };
